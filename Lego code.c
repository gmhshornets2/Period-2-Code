...
int main() {
    ...
    msleep(1000);
    //Drive forward to firefighter pre-placed on starting zone
    drive_with_gyro(500, 800);
    //Grab firefighter
    msleep(1000);
    set_servo_position(0,720);
    msleep(1000);
    drive_with_gyro(-500, 1000);
    msleep(1000);
    ...
    if (timesFound > 5) { 
        ...
        int firstBuilding = 1;
        //Releases firefighter in Medical Center/Complex zone for 25 points
        ...
        turnR(90.0);
        drive_with_gyro(1000, 2000);
        turnL(90.0); //turns toward second building
    } 
